...
for (const f of ['coach-knowledge.js','mi-projection.js','mi-ai.js','rank-standards.js']) { try { new Function(fs.readFileSync(f,'utf8')); console.log('OK  ', f); } catch (e) { ok = false; console.log('FAIL', f, e.message); } }
process.exit(ok ? 0 : 1);
